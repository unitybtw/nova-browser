      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          <div>
            ...
            <span className="font-mono-tracked text-[10px] text-neutral-400 block mb-1">
              20 TABS WITH HIBERNATION
            </span>
            <div className="font-display text-4xl font-bold text-[#171717] mb-4">
              ~420 <span className="text-xl font-normal text-neutral-400">MB</span>
            </div>

            <p className="font-body text-xs text-neutral-600 leading-relaxed">
              Background Webviews are gracefully suspended and unmounted from RAM without losing navigation history.
            </p>
          </div>
        ...
        >
          <div>
            ...
            <div className="font-display text-4xl font-bold text-[#171717] mb-4">
              ~380 <span className="text-xl font-normal text-neutral-400">ms</span>
            </div>
        ...
        {/* Metric 3: Search Omnibox Latency */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div>
            ...
            <div className="font-display text-4xl font-bold text-[#171717] mb-4">
              0 <span className="text-xl font-normal text-neutral-400">ms / 35 ms</span>
            </div>
