...
export const Footer: React.FC = React.memo(() => {
  ...
  return (
    <footer className="section-deferred relative w-full overflow-hidden bg-[#0c0d12] text-[#fcfbf9] font-sans mt-20 rounded-t-3xl border-t border-white/10 pt-16 pb-0">
