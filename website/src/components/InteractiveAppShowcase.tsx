...
export const InteractiveAppShowcase: React.FC = () => {
  ...
  return (
    <section id="simulator" className="py-28 px-6 max-w-7xl mx-auto">
      {/* Section Headline */}
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <h2 className="font-sans font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white tracking-tight mt-3">
          Experience the <span className="text-indigo-400">Living Interface</span>.
        </h2>
      ...
      <div
        ...
        className="relative rounded-[2rem] bg-[#0f172a] text-slate-100 shadow-2xl border border-white/10 overflow-hidden"
      >
        {/* Ambient Window Glow */}
        ...
        <div className="bg-[#090d16] px-4 pt-3 pb-0 border-b border-white/10 select-none flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline font-mono text-xs font-semibold text-slate-400 ml-2">
              Nova Client
            </span>
          </div>
          ...
          <div className="flex-1 max-w-2xl relative flex items-center">
            <div className="w-full bg-[#1e293b]/90 border border-white/10 rounded-xl py-1.5 pl-3 pr-24 text-xs font-mono text-slate-200 flex items-center gap-2 shadow-inner">
              ...
              <span className="text-slate-400">
                {activeTab === 'agent'
                  ? 'https://nova.sh/research/distributed-computing'
                  : activeTab === 'split'
              ...
              <div className="flex-1 p-6 sm:p-8 bg-[#0b1120] border-r border-white/10 relative overflow-hidden flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-xs text-slate-500 font-mono">ID: [data-ai-id="doc-702"]</span>
                  </div>

                  <h3 className="font-sans text-2xl sm:text-3xl font-bold text-white mb-4">
                    Distributed Memory Scheduling in Heterogeneous Environments
                  </h3>

                  <div className="space-y-3 text-slate-300 text-xs sm:text-sm leading-relaxed font-body">
                    <p
                      className={`p-2.5 rounded-xl transition-colors ${
                        agentStep >= 1 ? 'bg-indigo-500/15 border border-indigo-500/30 text-white' : ''
                      }`}
                    >
                      Topological fault-tolerant logic gates enable near-zero thermal dissipation across multi-threaded worker pools.
                    </p>
                    <p
                      className={`p-2.5 rounded-xl transition-colors ${
                        agentStep >= 2 ? 'bg-indigo-500/15 border border-indigo-500/30 text-white' : ''
                      }`}
                    >
                      Memory compaction algorithms reduce active heap fragmentation by 45.8% without pausing V8 execution contexts.
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-4 mt-6 border-t border-white/5 flex items-center justify-between text-[11px] font-mono text-slate-400">
                  ...
                  <span className="text-slate-500">WEBGPU TIME: 1.4ms</span>
                </div>
              </div>
              ...
              <div className="w-full lg:w-[380px] bg-[#0f172a] p-6 flex flex-col justify-between border-t lg:border-t-0 border-white/10">
                <div>
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-white/10 mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-sans font-semibold text-sm text-white">Nova Assistant</span>
                    </div>
                ...
                <div className="mt-6 pt-4 border-t border-white/10">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Extract Data Points', 'Summarize View', 'Audit Memory'].map((chip) => (
                      <button
                        key={chip}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-8">
                  <div className="p-4 rounded-2xl bg-[#0b1120] border border-white/10 text-center">
                    ...
                    <span className="font-sans text-3xl font-bold text-emerald-400">
                      {adBlockedCount}
                    </span>
                  </div>
                  <div className="p-4 rounded-2xl bg-[#0b1120] border border-white/10 text-center">
                    ...
                    <span className="font-sans text-2xl font-bold text-indigo-400">
                      AES-256-GCM
                    </span>
                  </div>
                  <div className="p-4 rounded-2xl bg-[#0b1120] border border-white/10 text-center">
                    ...
                    <span className="font-sans text-3xl font-bold text-white">0%</span>
                  </div>
                </div>
              </div>
