...
export const InteractiveMockup = () => {
  ...
  // States for realistic typing simulation
  ...
  return (
    <div className={`w-full max-w-4xl mx-auto h-[520px] rounded-2xl ${frameBg} ${borderColor} border shadow-2xl overflow-hidden flex flex-col relative hidden sm:flex font-sans`}>
