...
export const InteractiveMockup = ({ 
  ...
  return (
    <div className={`w-full h-full rounded-2xl overflow-hidden shadow-2xl relative border border-white/10 bg-slate-950/90 backdrop-blur-3xl group transition-all duration-700 ${className}`}>
      {/* Loading Spinner */}
      {!isReady && (
