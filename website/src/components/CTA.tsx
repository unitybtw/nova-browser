  ...
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Decorative gradients — visible on both light and dark */}
          <div className="absolute top-0 right-0 w-72 h-72 bg-white/10 dark:bg-blue-500/20 rounded-full filter blur-3xl opacity-60 translate-x-1/2 -translate-y-1/2" />
          <div className="absolute bottom-0 left-0 w-72 h-72 bg-white/10 dark:bg-purple-500/20 rounded-full filter blur-3xl opacity-60 -translate-x-1/2 translate-y-1/2" />
