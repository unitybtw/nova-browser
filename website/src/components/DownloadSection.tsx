...
export const DownloadSection: React.FC = () => {
  return (
    <section id="download" className="py-32 px-6 max-w-7xl mx-auto">
      <div className="relative rounded-[3rem] bg-[#0c081e] text-white p-10 sm:p-16 lg:p-20 overflow-hidden border border-white/10 shadow-2xl">
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-sans font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight mt-3">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* macOS Download Card */}
          <div className="p-8 rounded-3xl bg-white/[0.04] border border-white/10 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between group shadow-lg">
            <div>
              ...
              <h3 className="font-sans text-2xl font-bold mb-2">macOS</h3>
            ...
            <div>
              <a
                ...
                className="w-full py-3.5 px-6 rounded-full bg-white text-[#090A0F] font-mono text-xs font-bold tracking-wider uppercase inline-flex items-center justify-center gap-2 hover:bg-indigo-400 hover:text-white transition-colors duration-300 shadow-md group-hover:shadow-indigo-500/20"
              >
          ...
          <div className="p-8 rounded-3xl bg-white/[0.04] border border-white/10 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between group shadow-lg">
            <div>
              ...
              <h3 className="font-sans text-2xl font-bold mb-2">Windows</h3>
              <p className="font-body text-xs text-slate-400 mb-6 leading-relaxed">
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-center gap-8 mt-14 pt-8 border-t border-white/10 text-slate-400 text-xs font-mono">
