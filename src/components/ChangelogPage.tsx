...
export const ChangelogPage: React.FC<ChangelogPageProps> = ({
  ...
  const [selectedVersion, setSelectedVersion] = useState<string>(() => {
    return CHANGELOG_DATA[0]?.version || '1.4.8';
  });
        ...
        <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="text-xs px-2 py-0.5 rounded-full font-mono bg-cyan-100 dark:bg-cyan-900/40 text-cyan-700 dark:text-cyan-300 font-semibold">
                v{currentVersion}
              </span>
              {isLive && (
          ...
          <div className="flex items-center gap-2.5 shrink-0">
            ...
            <a
              ...
              className="px-4 py-2 rounded-xl text-xs font-semibold bg-slate-900 hover:bg-slate-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-950 transition-colors flex items-center gap-1.5 shadow-sm cursor-pointer"
            >
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all duration-200 cursor-pointer ${
                    isSelected
                      ? 'bg-white dark:bg-slate-900 border-cyan-500/40 dark:border-cyan-500/40 shadow-sm ring-1 ring-cyan-500/20'
            ...
            <>
              ...
              <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 shadow-sm">
                ...
                {currentRelease.highlights && currentRelease.highlights.length > 0 && (
                  <div className="p-4 rounded-2xl bg-slate-100/70 dark:bg-slate-900/60 border border-slate-200/80 dark:border-white/10">
                    <div className="text-xs font-semibold uppercase tracking-wider text-cyan-600 dark:text-cyan-400 mb-2.5 flex items-center gap-1.5">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <div className="relative w-full sm:w-64">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-1.5 rounded-xl text-xs bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/30"
                  />
                </div>
              </div>
