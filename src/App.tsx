...
function App({ demo: demoOptions }: { demo?: BrowserDemoOptions } = {}) {
  ...
  // Tab Hibernation & Webview LRU Pool Engine
  useTabHibernation({
    tabs,
    setTabs,
    tabsRef,
    ...
    splitTabId,
    activeSplitTabIdRef,
    tabHibernationEnabled: settings.tabHibernationEnabled,
    hibernationTimeoutMinutes: settings.hibernationTimeoutMinutes,
