...
const DEFAULT_CONFIG: SupabaseConfig = {
  url: import.meta.env?.VITE_SUPABASE_URL || 'https://nova-sync-default.supabase.co',
  anonKey: import.meta.env?.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.e30.dummyKeyForDemo',
  isCustom: false
};
