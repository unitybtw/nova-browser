...
export const Faq = () => {
  ...
  return (
    <section id="faq" className="py-24 px-4 sm:px-6 max-w-4xl mx-auto border-t border-[#252a3f]">
          ...
          return (
            ...
            >
              <button
                ...
                className="w-full p-5 text-left flex items-center justify-between gap-4 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <span className="hidden sm:inline font-mono text-[9px] text-slate-400 font-semibold px-2 py-0.5 rounded bg-[#1a1e2f] border border-[#252a3f]">
                    {faq.category}
                  </span>
                  <ChevronDown
              ...
              {isOpen && (
                <div className="px-5 pb-5 pt-0 font-sans text-xs sm:text-sm text-slate-300 leading-relaxed border-t border-[#252a3f] mt-1 pt-3.5">
                  <p>{faq.answer}</p>
                </div>
              )}
            </div>
